      ...
      <tr key={flight.flightId}>
        ...
        <td>
          <FormControlLabel value="Eco"
            ...
            control={<Radio />} label="Eco" /><br />{parseInt(flight.price.Eco.value).toLocaleString('it-IT', { style: 'currency', currency: 'INR' })}
        </td>
        <td>
          <FormControlLabel value="Deluxe"
            ...
            control={<Radio />} label="Deluxe" /><br />{parseInt(flight.price.Deluxe.value).toLocaleString('it-IT', { style: 'currency', currency: 'INR' })}</td>
        ...
        <td>
          <FormControlLabel value="SkyBOSS"
            ...
            control={<Radio />} label="SkyBOSS" /><br />{parseInt(flight.price.SkyBOSS.value).toLocaleString('it-IT', { style: 'currency', currency: 'INR' })}
        </td>
      </tr>
    )
  });
